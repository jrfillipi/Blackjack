...
public class BlackjackGame
{
	...
	/**
	 * Constructs a new BlackjackGame with a menu that includes the word
	 * Blackjack in a banner with the options of 'play game', 'show stats',
	 * 'game rules', and 'exit'
	 */
	...
	private void printBasicsOfBlackjack()
	{
		...
		try
		{
			...
			System.out.println(new String(Files.readAllBytes(Paths.get("src/Blackjack_Rules.txt"))));

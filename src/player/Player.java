...
public abstract class Player
{
	 ...
	 * 
	 * @param nextCard
	 *            takes an available card from the deck
	 */
	...
	public String showHand()
	{
		...
		for (Card eachCard : this.theirHand.getCardsDealt())
		{
			result += eachCard.getCardFace() + " ";
		}
	 ...
	 * 
	 * @return String returns all the Player's Cards in sequence and their Hand
	 *         total
	 */
